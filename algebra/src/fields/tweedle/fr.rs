/// Parameters for the base field of the Tweedle Dum curve (i.e. the scalar field of the Tweedle Dee)
use crate::{
...
impl FpParameters for FrParameters {
    ...
    // q = 2^254 + 4707489545178046908921067385359695873
    ...
    // 19400540447233431299362144148489679194329882900596822232901065060541459347406
