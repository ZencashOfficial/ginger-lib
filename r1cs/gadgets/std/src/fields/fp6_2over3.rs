/*
Definition of the degree 6 extension field gadget Fp6Gadget (as quadratic extension of of Fp3),
        ...
        P::Fp3Params: Fp3Parameters<Fp = ConstraintF>,
{
    ...
    /// Multiply by the (quadratic) nonresidue which defines the arithmetics of the quadratic ext.
    #[inline]
    ...
    */
    ...
    /* Optimized Karatsuba multiplication of Fp6 gadgets a = a0 + Y*a1 by Fp6 gadgets of the form
            b = b0 + Y*b1  with b0 = (0, 0, b0.2),
       saves two multiplications. Here, Fp4=Fp2[Y]/(Y^2-beta).
    */
    #[inline]
    ...
    {
        // optimized multiplication in Fp3, uses 3 multiplication instead of Toom-Cook's 5 mult.
        let v0 = {
...
/* FieldGadget implementation for Fp6Gadget as quadratic extension of Fp3.
*/
        ...
        P::Fp3Params: Fp3Parameters<Fp = ConstraintF>,
{
    ...
    */
    ...
    fn square<CS: ConstraintSystem<ConstraintF>>(&self, mut cs: CS) -> Result<Self, SynthesisError> {
        /* From Libsnark/fp2_gadget.tcc
         Complex multiplication for Fp2
            (1) v0 = A.c0 * A.c1
            (2) result.c0 = (A.c0 + A.c1) * (A.c0 + non_residue * A.c1) - (1 + non_residue) * v0
            (3) result.c1 = 2 * v0.
         Enforced by the first two constraints (1) and (2), result.c1 = 2*v0 is just an LC of v0.
        ...
        */
        ...
        // does not need extra constraint
    ...
    fn mul_equals<CS: ConstraintSystem<ConstraintF>>(
        ...
        /* Karatsuba multiplication for Fp6 as quadratic ext. of Fp3:
             v0 = A.c0 * B.c0
             v1 = A.c1 * B.c1
             result.c0 = v0 + non_residue * v1
             result.c1 = (A.c0 + A.c1) * (B.c0 + B.c1) - v0 - v1
         Enforced with 3 constraints:
           (1) A.c1 * B.c1 = v1
           (2) A.c0 * B.c0 = result.c0 - non_residue * v1
           (3) (A.c0+A.c1)*(B.c0+B.c1) = result.c1 + result.c0 + (1 - non_residue) * v1
         Reference:
         "Multiplication and Squaring on Pairing-Friendly Fields"
         Devegili, OhEigeartaigh, Scott, Dahab
        */
...
/* enforces that all two components of two Fp6Gadgets are not equal.
