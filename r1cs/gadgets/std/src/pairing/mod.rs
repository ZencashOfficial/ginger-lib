...
mod test {
    ...
    fn mnt4_753_gadget_bilinearity_test() {
        ...
        use super::mnt4753::MNT4753PairingGadget as PairingGadget;
        use crate::{
            groups::curves::short_weierstrass::mnt::mnt4::mnt4753::{
                MNT4G1Gadget as G1Gadget, MNT4G1PreparedGadget as G1PreparedGadget,
                MNT4G2Gadget as G2Gadget, MNT4G2PreparedGadget as G2PreparedGadget,
            },
            pairing::PairingGadget as _,
            prelude::*,
        };
        use algebra::curves::mnt4753::{MNT4, G1Projective, G2Projective};
        use std::ops::Mul;
        ...
        let (ans3_g, ans3_n) = {
            ...
            let mut ans_g =
                PairingGadget::pairing(cs.ns(|| "pair(a, b)"), a_prep_g.clone(), b_prep_g.clone())
                    .unwrap();
            let mut ans_n = MNT4::pairing(a, b);
            ans_n = ans_n.pow(s.into_repr());
            ans_g = ans_g.pow(cs.ns(|| "pow"), &s_iter).unwrap();
    ...
    fn mnt6_753_gadget_bilinearity_test() {
        ...
        use super::mnt6753::MNT6753PairingGadget as PairingGadget;
        use crate::{
            groups::curves::short_weierstrass::mnt::mnt6::mnt6753::{
                MNT6G1Gadget as G1Gadget, MNT6G1PreparedGadget as G1PreparedGadget,
                MNT6G2Gadget as G2Gadget, MNT6G2PreparedGadget as G2PreparedGadget,
            },
            pairing::PairingGadget as _,
            prelude::*,
        };
        use algebra::curves::mnt6753::{MNT6, G1Projective, G2Projective};
        use std::ops::Mul;
        ...
        let (ans3_g, ans3_n) = {
            ...
            let mut ans_g =
                PairingGadget::pairing(cs.ns(|| "pair(a, b)"), a_prep_g.clone(), b_prep_g.clone())
                    .unwrap();
            let mut ans_n = MNT6::pairing(a, b);
            ans_n = ans_n.pow(s.into_repr());
            ans_g = ans_g.pow(cs.ns(|| "pow"), &s_iter).unwrap();
